...
const About: React.FC<AboutPageProps> = ({ history, ...props }) => {
  const sections = [
    {
      ...
      content: (
        <React.Fragment>
          <p>
            ...
            in 2016 by <ExternalLink href={`${documentationLinks.introBlog}`} text="CoreOS" />. Since then, significant
          ...
          <p>
            ...
            <ExternalLink href={`${documentationLinks.olm}`} text="Operator Lifecycle Manager"  /> to install, manage and
      ...
      content: (
        <React.Fragment>
          <p>
            ...
            <ExternalLink href={`${documentationLinks.buildYourCSV}`} text="ClusterServiceVersion"  /> in the{' '}
            <ExternalLink href={`${documentationLinks.operatorsRepo}`} text="GitHub repository"  /> is used to populate
            ...
            allows a user to “
            <ExternalLink href={`${documentationLinks.olmArchitecture}`} text="subscribe"  />” to an Operator, which
            ...
            <ExternalLink href={`${documentationLinks.discoveryCatalogs}`} text="selection of channels"  /> (e.g. ‘stable’
      ...
      content: (
        <React.Fragment>
          <p>
            ...
            be developed with the <ExternalLink href={`${documentationLinks.operatorSdk}`} text="operator-sdk"  />.
            ...
            <ExternalLink href="https://quay.io" text="quay.io"  /> or{' '}
            <ExternalLink href="https://hub.docker.com" text="docker.io"  />.
          </p>
          <p>
            ...
            <ExternalLink href={documentationLinks.operatorsRepo} text="GitHub"  />.
          </p>
        </React.Fragment>
      )
    },
