...
const olmArchitecture = `${olm}/blob/master/doc/design/architecture.md`;
const buildYourCSV = `${olm}/blob/master/doc/design/building-your-csv.md`;
...
const capabilityLevelModelDiagram = `${operatorSdk}/blob/master/doc/images/operator-capability-level.png`;
const manageOperatorWithOlm = `${operatorsFramework}/getting-started#manage-the-operator-using-the-operator-lifecycle-manager`;
const operatorGroupDesign = `${olm}/blob/master/doc/design/architecture.md#operator-group-design`;
