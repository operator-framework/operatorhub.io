...
export const operatorsRepoBeforePR = `${operatorsRepo}/blob/master/docs/contributing.md#submitting-your-operator`;
export const operatorsRepoRequirements = `${operatorsRepo}/blob/master/docs/contributing.md#package-your-operator`;
...
export const operatorMetadataValidation = `${operatorsRepo}/blob/master/docs/testing-operators.md#operator-metadata-validation`;
...
export const buildYourCSV = `${operatorsRepo}/blob/master/docs/contributing.md#create-a-clusterserviceversion`;
export const createPackageManifest = `${operatorsRepo}/blob/master/docs/contributing.md#create-a-release-using-the-packagemanifest-format`;
...
export const packagemanifestToBundle = `${operatorsRepo}/blob/master/docs/contributing.md#moving-from-packagemanifest-to-bundle-format`;
